...
ladders = { 'LIZ600': { 'dye': 'LIZ',
            ...
            'Orange650': { 'dye': 'Orange',
                        'sizes': [60.0,80.0,100.0,114.0,119.0,140.0,160.0,180.0,203.0,
                                    214.0,220.0,240.0,250.0,260.0,280.0,300.0,
                                    314.0,320.0,340.0,360.0,380.0,400.0,
                                    414.0,420.0,440.0,460.0,480.0,500.0,
                                    514.0,520.0,540.0,560.0,580.0,600.0,620.0,650.0],
                        'strict': {
                            'max_rss': 40.0,
                            'min_dpscore': 34.0,
                            'min_sizes': 36
            ...
            'Orange600': { 'dye': 'Orange',
                        'sizes': [60.0,80.0,100.0,
                                    114.0,120.0,140.0,160.0,180.0,200.0,
                                    214.0,220.0,240.0,260.0,280.0,300.0,
                                    314.0,320.0,340.0,360.0,380.0,400.0,
                                    414.0,420.0,440.0,460.0,480.0,500.0,
                                    514.0,520.0,540.0,560.0,580.0,600.0],
                        'strict': {
                            'max_rss': 40.0,
                            'min_dpscore': 28.0,
                            'min_sizes': 33
                        ...
                        'k': 6,
                        'a': 2,
                        'signature': [140, 160, 180, 200, 214, 220, 240, 260, 280, 300, 314, 320],
                        'order': 3,
                    },
            'GS600': {'dye': 'LIZ',
                       'sizes': [60, 80, 100, 114, 120, 140, 160, 180, 200, 214, 220, 240, 250, 260, 280, 300, 314, 320, 340, 360,
                                 380, 400, 414, 420, 440, 460],
                       'strict': {
                           'max_rss': 36,
                           'min_dpscore': 24.0,
                           'min_sizes': 26
                       ...
                       'k': 4,
                       'a': 1,
                       'signature': [120, 140, 160, 180, 200, 214, 220],
                       'order': 2,
                       },
}

# ladder = ladders['GS600']
# ladder = ladders['LIZ600']
ladder = ladders['Orange600']
